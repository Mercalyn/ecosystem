...
const designation = objArrayParams => {
    /*
    objArrayParams = {
        version: 1, // int/float
    ...
    */
    ...
    if(objArrayParams.version === 1){
        ...
        if(arrayParams.length < 3){
            ...
            // compile string
            let adjective = adjectivesList[values[0] % adjectivesList.length];
            let material = materialsList[values[2] % materialsList.length];
            let noun = nounsList[values[1] % nounsList.length];
